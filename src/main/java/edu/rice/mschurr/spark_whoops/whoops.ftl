...
<html>
  ...
  <body>
      ...
      <div class="stack-container">
        ...
        <div class="left-panel cf empty">
          ...
          <header>
            <div class="exception">
              <div class="exc-title">
                <#list 0..name?size-1 as i><#if i == name?size-1><span class="exc-title-primary">${name[i]}</span><#else>${name[i]}.</#if></#list>
    ...
    <script type="text/javascript"><#noescape>${zepto_js}</#noescape></script>
    <script type="text/javascript"><#noescape>${clipboard_js}</#noescape></script>
    <script type="text/javascript"><#noescape>${whoops_js}</#noescape></script>
  </body>
</html>
</#escape>
